...
B_none = Tk.Button(root, text = 'No Effect', command = case_noeffect, height = 5, width = 12)
B_amp = Tk.Button(root, text = 'Robot', command = case_amplitude_mod, height = 5, width = 12)
B_dv = Tk.Button(root, text = 'Darth Vader', command = case_darth_vader, height = 5, width = 12)
B_al = Tk.Button(root, text = 'Alien', command = case_alien, height = 5, width = 12)
B_bb = Tk.Button(root, text = 'Baby', command = case_baby, height = 5, width = 12)


Label_sound = Tk.Label(root, text='Background Sounds', font=("Georgia, 16"))
B_harbor = Tk.Button(root, text = 'Harbor', command = case_harbour_sound, height = 5, width = 12)
B_park = Tk.Button(root, text = 'Park', command = case_park_sound, height = 5, width = 12)
B_sw = Tk.Button(root, text = 'Star Wars', command = case_starwars_sound, height = 5, width = 12)
B_space = Tk.Button(root, text = 'Outer Space', command = case_space_sound, height = 5, width = 12)
B_none_sound = Tk.Button(root, text = 'No Sound', command = case_no_sound, height = 5, width = 12)

B_resume = Tk.Button(root, text = 'Resume', command = fun_resume, height = 5, width = 12)
B_pause = Tk.Button(root, text = 'Pause', command = fun_pause, height = 5, width = 12)
