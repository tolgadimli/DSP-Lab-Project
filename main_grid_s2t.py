...
no_ef = PhotoImage(file = r"/assets/no_effect.png")
robot = PhotoImage(file = r"/assets/robot.png")
vader = PhotoImage(file = r"/assets/dv.png")
alien = PhotoImage(file = r"/assets/alien.png")
baby = PhotoImage(file = r"/assets/baby.png")
sea = PhotoImage(file = r"/assets/sea.png")
park = PhotoImage(file = r"/assets/park.png")
sw = PhotoImage(file = r"/assets/star_wars.png")
space = PhotoImage(file = r"/assets/space.png")
play = PhotoImage(file = r"/assets/play.png")
pause = PhotoImage(file = r"/assets/pause.png")
quit = PhotoImage(file = r"/assets/quit.png")



Label_effect = Tk.Label(root, text='Sound Effects', font=("Georgia, 16"))
B_none = Tk.Button(root, text = 'No Effect', command = case_noeffect, height = 5, width = 12, image = no_ef, compound=TOP)
B_amp = Tk.Button(root, text = 'Robot', command = case_amplitude_mod, height = 5, width = 12, image = robot, compound=TOP)
B_dv = Tk.Button(root, text = 'Darth Vader', command = case_darth_vader, height = 5, width = 12, image = vader, compound=TOP)
B_al = Tk.Button(root, text = 'Alien', command = case_alien, height = 5, width = 12, image = alien, compound=TOP)
B_bb = Tk.Button(root, text = 'Baby', command = case_baby, height = 5, width = 12, image = baby, compound=TOP)


Label_sound = Tk.Label(root, text='Background Sounds', font=("Georgia, 16"))
B_harbor = Tk.Button(root, text = 'Harbor', command = case_harbour_sound, height = 5, width = 12, image = sea, compound=TOP)
B_park = Tk.Button(root, text = 'Park', command = case_park_sound, height = 5, width = 12, image = park, compound=TOP)
B_sw = Tk.Button(root, text = 'Star Wars', command = case_starwars_sound, height = 5, width = 12, image = sw, compound=TOP)
B_space = Tk.Button(root, text = 'Outer Space', command = case_space_sound, height = 5, width = 12, image = space, compound=TOP)
B_none_sound = Tk.Button(root, text = 'No Sound', command = case_no_sound, height = 5, width = 12, image = no_ef, compound=TOP)

B_resume = Tk.Button(root, text = 'Resume', command = fun_resume, height = 5, width = 12, image = play, compound=TOP)
B_pause = Tk.Button(root, text = 'Pause', command = fun_pause, height = 5, width = 12, image = pause, compound=TOP)
B_quit = Tk.Button(root, text = 'Save & Quit', command = fun_quit, height = 5, width = 12, image = quit, compound=TOP)
